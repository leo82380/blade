...
public class RoadRunnerEffect : MonoBehaviour
{
    ...
    private IEnumerator TypeOneCharacter(TMP_TextInfo textInfo, int index)
    {
        ...
        else
        {
            ...
            Vector3 v2Origin = vertices[v3]; //글자의 우측 상단
            ...
            while(percent < 1)
            {
                ...
                float xDelta = Mathf.Lerp(2f, 0, percent);
                vertices[v1] = v1Origin + new Vector3(xDelta, 0, 0);
                vertices[v2] = v2Origin + new Vector3(xDelta, 0, 0);
